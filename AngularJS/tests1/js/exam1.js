...
// 'name', 'List of Modules You need for Program to function -- between []'
...
app1.controller('ctrl1', function($scope) {   <!-- ng-controller="ctrl1" -->

    // Define initial values 
    $scope.name = 1;     <!-- ng-model="first" -->
    $scope.email = 1;    <!-- ng-mode="second" -->
    ...
    $scope.updateValue = function() {     <!-- ng-click="updateValue()" -->
        $scope.calculation = $scope.first + ' + ' + $scope.second +
            " = " + (+$scope.first + +$scope.second);   <!-- {{calculation}} -->
    };

    $scope.createForm = function() {     <!-- ng-click="updateValue()" -->
        $scope.formFields = '<div><input type="text">';
    };
});